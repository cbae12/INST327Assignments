...
-- --- with the name new_invoice_row
	AFTER INSERT ON invoices-- add here the name of the table 
...
BEGIN
	...
	INSERT INTO new_invoice_records VALUES(invoice_id_var, 
    CONCAT('You have added a new invoice from IBM with an invoice total of ', '$',invoice_total_var), SYSDATE());
